clear all; close all;
clc;
seed_rng = rng;%(15) %if seed is 9, the example trajectory is reproduced in the paper
%% intialize
radius = 30;
s = -3;
b.s = -radius:radius; %-30:30
...
pomdp = POMDP_LightDark1D(pomdp_params, radius);
...
solver_params.k_o = 5.0; %5.0
solver_params.alpha_o = 1.0/15.0; %1.0/15.0
